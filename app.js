...
// // Function to calculate points and end game
// function endGameWithPoints() {
//     const player1Points = calculatePoints('black');
//     const player2Points = calculatePoints('white');
...
// // Function to calculate points for a player
// function calculatePoints(playerColor) {
//     let playerPoints = 0;
//     const playerPieces = document.querySelectorAll(`.${playerColor}`);

//     playerPieces.forEach(piece => {
//         // Add points for each piece based on your scoring system
//         playerPoints += 1; // Example: Each piece is worth 1 point
//     });
